                ...
                <div className="glass-panel px-6 py-3 flex items-center justify-between border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl bg-white/5">
                    <div className="flex items-center gap-3 cursor-pointer group" onClick={() => onNavigate('dashboard')}>
                        <div className="relative">
                            <img src="/logo.jpg" alt="Logo" className="w-10 h-10 rounded-full border border-[#00E5FF]/30 object-cover group-hover:border-[#00E5FF] transition-all" />
                        ...
                        <div className="hidden sm:block">
                            ...
                            <p className="text-[10px] text-[#00E5FF] font-bold uppercase tracking-[0.2em] opacity-80 mt-1">Extramural</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 pl-4 border-l border-white/10 ml-2">
                        <div className="text-right hidden sm:block">
                            ...
                            <p className="text-[9px] text-gray-500 uppercase font-black tracking-widest mt-1 opacity-70">
                                {user?.cargo?.includes('(') ? user.cargo.split('(')[0] : user?.cargo}
                            </p>
                        </div>
                        <button
                            onClick={logout}
